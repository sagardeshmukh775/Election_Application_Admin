...
public class Update_Member_Activity extends AppCompatActivity implements View.OnClickListener, OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ArrayAdapter<String> occupation = new ArrayAdapter<String>(Update_Member_Activity.this,
...
//        setFromDateClickListner();
        ...
        Delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(Update_Member_Activity.this);
...
//
                                        appleSnapshot.getRef().removeValue();
                                        Toast.makeText(Update_Member_Activity.this, "Delete Product Successfully", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(Update_Member_Activity.this,MainActivity.class);
...
//                int spinnerPosition = myAdap.getPosition(occupation);
    ...
    private void SetData() {
        ...
        if (code.equalsIgnoreCase("2")) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(Update_Member_Activity.this);
            ...
            sRef.putFile(filePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    progressDialog.dismiss();
                    Toast.makeText(Update_Member_Activity.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                }
    ...
    private void updateLeed(String leedId, Map leedsMap) {
        ...
        leedRepository.updateLeed(leedId, leedsMap, new CallBack() {
            ...
            public void onSuccess(Object object) {
                ...
                Toast.makeText(Update_Member_Activity.this, "Member Updated", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Update_Member_Activity.this,MainActivity.class);
                startActivity(intent);
            }
        ...
        try {
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toast.makeText(Update_Member_Activity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void setFromDateClickListner() {
        ...
        etmemberbirthdate.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean b) {
                DatePickerDialog mDatePicker = new DatePickerDialog(Update_Member_Activity.this, new DatePickerDialog.OnDateSetListener() {
